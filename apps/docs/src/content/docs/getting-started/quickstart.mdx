...
Truss is open source and self-hosted. Clone it, point it at a Postgres database, and you have the full platform running locally with no signup, no limits, and no external services required.
...
```bash
git clone https://github.com/binarysquad/truss
cd truss
npm install
```
